...
local rofi_command = 'env /usr/bin/rofi -dpi ' .. get_dpi() .. ' -width ' .. with_dpi(400) .. ' -show drun -modi drun -theme ' .. filesystem.get_configuration_dir() .. '/configuration/rofi.rasi'
...
return {
  ...
  default = {
    ...
    social = 'flatpak run com.slack.Client',
    game = rofi_command,
    files = 'nautilus',
    music = rofi_command
  },
  ...
  run_on_start_up = {
    ...
    'nm-applet', -- wifi
    'flatpak run com.dropbox.Client', -- Dropbox
